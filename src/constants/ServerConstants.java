...
public class ServerConstants {
    ...
    //Packet offset for showing item EXP.
    public static int getItemEXPPacketOffset(int itemReqLevel){
        return 1; //TODO code
    }
    ...
    public static final int CURRENCY = 4001055; // TODO: CHANGE
    public static final String FM_BGM = "Bgm15/ElinForest";
    public static final boolean hcEnabled = false; //Whether or not to enable the Nightmare server
    ...
    //Specify a mob ID here and its drops will automatically become instanced; that is, every player in the expedition
    //will receieve their own drops and will not be able to loot other players' drops.
