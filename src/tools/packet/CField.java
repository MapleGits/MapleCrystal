...
public class CField {
    ...
    public static byte[] getPublicNPCInfo() {
        ...
        for (int i = 0; i < publicNpcIds.length; i++) {
            mplew.writeMapleAsciiString("");
            mplew.writeInt(publicNpcIds[i]);
            mplew.writeInt(i);
            mplew.writeInt(0);
            mplew.writeMapleAsciiString(publicNpcs[i]);
        }
        return mplew.getPacket();
    }
    ...
    public static byte[] showPotentialReset(boolean fireworks, int chr, boolean success, int itemid) {
        ...
        mplew.writeShort(/*fireworks ? SendPacketOpcode.SHOW_FIREWORKS_EFFECT.getValue() : */SendPacketOpcode.SHOW_POTENTIAL_RESET.getValue()); //SHOW_FIREWORKS_EFFECT crashes, incorrect opcode.
        mplew.writeInt(chr);
...
//     }
    ...
    public static class EffectPacket {
        ...
        public static byte[] showDiceEffect(int cid, int skillid, int effectid, int effectid2, int level, byte diceNum) {
            ...
            mplew.writeInt(skillid);
            mplew.write(level);
            mplew.write(0);//for double down, this is 0 for left die, 1 for right
