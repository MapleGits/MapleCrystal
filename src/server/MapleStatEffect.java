...
//    private List<Pair<Integer, Integer>> randomMorph;
    ...
    private short ignoreMob, mesoR, thaw, fatigueChange, lifeId, imhp, immp, inflation, useLevel, indiePdd, indieMdd, incPVPdamage, mobSkill, mobSkillLevel, criticalR = 0, evadeProb = 0;
    ...
    private static MapleStatEffect loadFromData(final MapleData source, final int sourceid, final boolean skill, final boolean overTime, final int level, final String variables) {
        ...
        if (ret.overTime && ret.getSummonMovementType() == null && !ret.isEnergyCharge()) {
            ...
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.CRITICAL_RATE_BUFF, Integer.valueOf(ret.criticalR));
            ...
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.STR, ret.info.get(MapleStatInfo.indieSTR));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.DEX, ret.info.get(MapleStatInfo.indieDEX));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.INT, ret.info.get(MapleStatInfo.indieINT));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.LUK, ret.info.get(MapleStatInfo.indieLUK));
            ...
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ENHANCED_WDEF, ret.info.get(MapleStatInfo.indiePdd));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ENHANCED_MDEF, ret.info.get(MapleStatInfo.indieMdd));
            ...
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ABNORMAL_STATUS_R, ret.info.get(MapleStatInfo.asrR));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ELEMENTAL_STATUS_R, ret.info.get(MapleStatInfo.terR));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.ANGEL_AVOID, ret.info.get(MapleStatInfo.evadeProb));
            addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.STANCE, ret.info.get(MapleStatInfo.stance));
            //addBuffStatPairToListIfNotZero(ret.statups, MapleBuffStat.INVINCIBLE, ret.info.get(MapleStatInfo.itemInvincible));
        ...
        if (ret.skill) { // hack because we can't get from the datafile...
            switch (sourceid) {
                ...
                case 35001002:
                    ...
                    /*ret.statups.put(MapleBuffStat.MDEF, ret.info.get(MapleStatInfo.emdd));
                     ret.statups.put(MapleBuffStat.WDEF, ret.info.get(MapleStatInfo.epdd));
                     ret.statups.put(MapleBuffStat.MAXHP, ret.info.get(MapleStatInfo.emhp));
                     ret.statups.put(MapleBuffStat.MAXMP, ret.info.get(MapleStatInfo.emmp));
                     ret.statups.put(MapleBuffStat.ANGEL_SPEED, ret.info.get(MapleStatInfo.indieSpeed));*/
                ...
                case 1101007: // pguard
                case 1201007:
                case 11101006: //Power Reflection
                ...
                case 5111010: // Admiral's Wings
                    //ret.statups.put(MapleBuffStat.COMBO_BARRIER, ret.info.get(MapleStatInfo.x));
                    ret.statups.put(MapleBuffStat.DAMAGE_TAKEN_BUFF, ret.info.get(MapleStatInfo.x));
                    break;
                ...
                case 22151002: //killer wings
                    ...
                    break;
                case 4341007:
                    //ret.statups.put(MapleBuffStat.ANGEL_ATK, ret.info.get(MapleStatInfo.epad));
                ...
                case 51121006: // Mihile || Roiling Soul
                    ...
                    ret.statups.put(MapleBuffStat.ENRAGE, 1);
                ...
                case 51111003: // Mihile || Radiant Charge
                    ret.statups.put(MapleBuffStat.DAMAGE_BUFF, ret.info.get(MapleStatInfo.indieDamR));
                ...
                case 3220005:
                    ...
                    //ret.statups.put(MapleBuffStat.TOTAL_DAMAGE_RED, ret.info.get(MapleStatInfo.damage));
                    ret.statups.put(MapleBuffStat.DEFENCE_BOOST_R, ret.info.get(MapleStatInfo.y));
                    ret.statups.put(MapleBuffStat.HP_BOOST_PERCENT, ret.info.get(MapleStatInfo.x));
                ...
                case 5211009:
                    ret.info.put(MapleStatInfo.time, 2100000000);
                    ret.statups.put(MapleBuffStat.WATK, ret.info.get(MapleStatInfo.y));
                    ret.info.put(MapleStatInfo.attacksRemaining, ret.info.get(MapleStatInfo.x));
                    break;
                case 35001001: //flame
                case 35101009:
                ...
                case 31111004: // black hearted strength					
                    ...
                    break;
                case 24121004:
                    //ret.statups.put(MapleBuffStat.IGNORE_DEFENSE_R, ret.info.get(MapleStatInfo.x));
                    //ret.statups.put(MapleBuffStat.TOTAL_DAMAGE_RED, ret.info.get(MapleStatInfo.damR));
                    break;
                default:
                    break;
            }
            if (GameConstants.isBeginnerJob(sourceid / 10000)) {
                switch (sourceid % 10000) {
                    ...
                    case 30018005:
                    case 8005:
                        ret.statups.put(MapleBuffStat.DECENT_ADVANCE_BLESS, 1);
                        break;
                    case 8006:
                        ret.statups.put(MapleBuffStat.SPEED_INFUSION, ret.info.get(MapleStatInfo.x));
                        break;
    ...
    public final boolean applyTo(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final Point pos, int newDuration) {
        ...
        if(mpchange < 0 && applyfrom.getBuffedValue(MapleBuffStat.MP_CON_INCREASE) != null){
            mpchange *= 1.0d + (applyfrom.getBuffedValue(MapleBuffStat.MP_CON_INCREASE) / 100.0d);
            if(applyfrom.getBuffedValue(MapleBuffStat.C_CONSUME_HP) != null){
                hpchange = mpchange;
            }
        }
        ...
        if (hpchange != 0) {
            ...
            if (applyto.getHcMode() != 1) {
                stat.setHp(stat.getHp() + hpchange, applyto);
            } else {
                if (!primary) { //[CUSTOM]: slow-healing for potions
                    stat.setHp(stat.getHp() + hpchange, applyto); //skills
                } else if (hpchange > 0 || mpchange > 0) { //potions
                    final int hpChunk = (int) Math.ceil(hpchange / GameConstants.potionDuration);
                    Runnable healTimer = new Runnable() {
                        @Override
                        public void run() {
                            stat.setHp(stat.getHp() + hpChunk, applyto);
                            applyto.updateSingleStat(MapleStat.HP, Integer.valueOf(stat.getHp()));
                        }
                    };
                    for (int i = 0; i < GameConstants.potionDuration; i++) {
                        BuffTimer.getInstance().schedule(healTimer, 1000 * i);
                    }
                }
            }
        }
...
//	final ScheduledFuture<?> schedule = TimerManager.getInstance().schedule(cancelAction, ((starttime + 99999) - System.currentTimeMillis()));
    ...
    private void applyBuffEffect(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final int newDuration) {
        ...
        switch (sourceid) {
            ...
            case 2259171: {
                ...
                localstatups.put(MapleBuffStat.CRITICAL_RATE_BUFF, 5);
                break;
            }
            case 2259173: {
                localstatups = new EnumMap<>(MapleBuffStat.class);
                localstatups.put(MapleBuffStat.CRITICAL_RATE_BUFF, 10);
                break;
            }
            case 2259175: {
                localstatups = new EnumMap<>(MapleBuffStat.class);
                localstatups.put(MapleBuffStat.ABNORMAL_STATUS_R, 20);
                localstatups.put(MapleBuffStat.ELEMENTAL_STATUS_R, 20);
                break;
            }
            case 2259176: { //weapon & magic def +100%
                localstatups = new EnumMap<>(MapleBuffStat.class);
                //localstatups.put(MapleBuffStat.ENHANCED_MDEF, applyto.getStat().mdef);
                //localstatups.put(MapleBuffStat.ENHANCED_WDEF, applyto.getStat().wdef);
                localstatups.put(MapleBuffStat.DEFENCE_BOOST_R, 100);
                break;
            }
            case 2259177: {
                localstatups = new EnumMap<>(MapleBuffStat.class);
            ...
            case 5311004: {
                ...
                applyto.getMap().broadcastMessage(applyto, CField.EffectPacket.showDiceEffect(applyto.getId(), sourceid, zz, -1, (int) level, (byte) 0), false);
                applyto.getClient().getSession().write(CField.EffectPacket.showOwnDiceEffect(sourceid, zz, -1, (int) level, (byte) 0));
            ...
            case 5211007: {//dice
                ...
                applyto.getMap().broadcastMessage(applyto, EffectPacket.showDiceEffect(applyto.getId(), sourceid, zz, -1, level, (byte) 0), false);
                applyto.getClient().getSession().write(EffectPacket.showOwnDiceEffect(sourceid, zz, -1, level, (byte) 0));
                if (zz <= 1) {
                    return;
                }
                int toApply = 0;
                if (applyfrom.getTotalSkillLevel(5720005) > 0 && SkillFactory.getSkill(5720005).getEffect(applyfrom.getTotalSkillLevel(5720005)).makeChanceResult()) {
                    toApply = 5720005;
                }
                if (applyfrom.getTotalSkillLevel(5120012) > 0 && SkillFactory.getSkill(5120012).getEffect(applyfrom.getTotalSkillLevel(5120012)).makeChanceResult()) {
                    toApply = 5120012;
                }
                if (applyfrom.getTotalSkillLevel(5220014) > 0 && SkillFactory.getSkill(5220014).getEffect(applyfrom.getTotalSkillLevel(5220014)).makeChanceResult()) {
                    toApply = 5220014;
                }
                if (applyfrom.getTotalSkillLevel(5320007) > 0 && SkillFactory.getSkill(5320007).getEffect(applyfrom.getTotalSkillLevel(5320007)).makeChanceResult()) {
                    toApply = 5320007;
                }

                if (toApply != 0) {
                    int localProp = applyfrom.getTotalSkillLevel(toApply) * 10;
                    if (Randomizer.nextInt(101) < localProp) {
                        SkillFactory.getSkill(toApply).getEffect(applyfrom.getTotalSkillLevel(toApply)).applyBuffEffect(applyfrom, applyto, primary, newDuration);
                        return;
                    }
                }
                localstatups = new EnumMap<>(MapleBuffStat.class);
                localstatups.put(MapleBuffStat.DICE_ROLL, zz);
                applyto.getClient().getSession().write(BuffPacket.giveDice(zz, sourceid, localDuration, localstatups, (short) zz));
                normal = false;
                showEffect = false;
                break;
            }
            ...
            case 5320007: {//dice
                ...
                int zz2 = 0;
                if (makeChanceResult()) {
                    zz2 = Randomizer.nextInt(6) + 1;
                }
                applyto.getMap().broadcastMessage(applyto, EffectPacket.showDiceEffect(applyto.getId(), sourceid, zz, zz2 > 0 ? -1 : 0, level, (byte) 0), false);
                applyto.getMap().broadcastMessage(applyto, EffectPacket.showDiceEffect(applyto.getId(), sourceid, zz2, zz2 > 0 ? -1 : 0, level, (byte) 1), false);
                applyto.getClient().getSession().write(EffectPacket.showOwnDiceEffect(sourceid, zz, zz2 > 0 ? -1 : 0, level, (byte) 0));
                applyto.getClient().getSession().write(EffectPacket.showOwnDiceEffect(sourceid, zz2, zz2 > 0 ? -1 : 0, level, (byte) 1));
                if ((zz <= 1 && zz2 <= 1) || (zz2 == 1)) {
                    return;
                }
                localstatups = new EnumMap<>(MapleBuffStat.class);
                ...
                if (zz2 > 1) {
                    ...
                    applyto.getClient().getSession().write(BuffPacket.giveDice(zz, sourceid, localDuration, localstatups, (short) zz));
                    //applyto.getClient().getSession().write(BuffPacket.giveDice(zz2, sourceid, localDuration, localstatups, (short)zz2));
                } else {
                    applyto.getClient().getSession().write(BuffPacket.giveDice(zz, sourceid, localDuration, localstatups, (short) zz));
                }
                normal = false;
                showEffect = false;
                // System.out.println("zz: " + zz + " zz2: " + zz2 + "");
                break;

            }
            case 20031209:
            case 20031210:
                int zz = Randomizer.nextInt(this.sourceid == 20031209 ? 2 : 5);
                ...
                applyto.getMap().broadcastMessage(applyto, CField.gainCardStack(applyto.getId(), applyto.getRunningStack(), (skillid == 24120002) ? 2 : 1, skillid, Randomizer.rand(100000, 500000), (skillid == 24100003) ? 5 : 10), true);
                applyto.getMap().broadcastMessage(applyto, CField.EffectPacket.showDiceEffect(applyto.getId(), this.sourceid, zz, -1, this.level, (byte) 0), false);
                applyto.getClient().getSession().write(CField.EffectPacket.showOwnDiceEffect(this.sourceid, zz, -1, this.level, (byte) 0));
                int itemid = 0;
                if (this.sourceid == 20031209) {
                    itemid = 2259171 + zz;
                } else {
                    itemid = 2259173 + zz;
                }
                if (itemid != 0) {
                    MapleItemInformationProvider.getInstance().getItemEffect(itemid).applyTo(applyto);
                }
                normal = false;
                showEffect = false;
                break;
            ...
            case 15001003: {
                int buffID = 2259100 + applyto.getTotalSkillLevel(SkillFactory.getSkill(15001003));
           ...
           case 24121004: //what are you, stupid?
            ...
            case 2320011: //arcane aim
                if (applyto.getFirstLinkMid() > 0) {
                    ...
                    /*localDuration = 5000;
                    localstatups = new EnumMap<>(MapleBuffStat.class);
                    localstatups.put(MapleBuffStat.TOTAL_DAMAGE_RED, applyto.getDamageIncrease(applyto.getFirstLinkMid()));
                    applyto.getClient().getSession().write(BuffPacket.giveBuff(sourceid, localDuration, localstatups, this));*/
                } else {
                    return;
                }
            ...
            case 32111005: { //body boost
                ...
                if (applyfrom.getStatForBuff(MapleBuffStat.BLUE_AURA) != null) {
                    ...
                    istat.put(MapleBuffStat.INVINCIBLE, 100);
                    ...
                    final Runnable icancelAction = new Runnable() {
                        ...
                        public void run() {
                            if (applyto != null && !applyto.isClone()) {
                                applyto.cancelBuffStats(MapleBuffStat.INVINCIBLE);
                            }
                        }
                    };
            ...
            case 4330009:
                localstatups = new EnumMap<>(MapleBuffStat.class);
                localstatups.put(MapleBuffStat.CRITICAL_RATE_BUFF, 100);
                localstatups.put(MapleBuffStat.ENHANCED_WATK, (int) (5 + Math.floor(applyto.getTotalSkillLevel(4330009) / 2))); //5+d(x/2)
                //applyto.getClient().getSession().write(BuffPacket.giveBuff(sourceid, 1, localstatups, this));
                break;
            case 4341007:
                localstatups = new EnumMap<>(MapleBuffStat.class);
                localstatups.put(MapleBuffStat.ANGEL_ATK, statups.get(MapleBuffStat.ENHANCED_WATK));
            ...
            default:
                if (isPirateMorph()) {
                 ...
                 localstatups = new EnumMap<>(MapleBuffStat.class);
                 localstatups.put(MapleBuffStat.CRITICAL_RATE_BUFF, (int)criticalR);
                 }*/
    ...
    public final int getCooldown(final MapleCharacter chra) {
        ...
        if (chra.getStat().coolTimeR > 0) {
            return (int) Math.max(0, ((info.get(MapleStatInfo.cooltime) * (1.0d - (chra.getStat().coolTimeR / 100))) - chra.getStat().reduceCooltime));
        }
    ...
    public boolean isMist() {
        return skill && (sourceid == 2111003 || sourceid == 4221006 || sourceid == 12111005 || 
                    sourceid == 14111006 || sourceid == 22161003 || sourceid == 32121006 || 
                    sourceid == 1076 || sourceid == 11076 || sourceid == 4121015); // poison mist, smokescreen and flame gear, recovery aura
    }
