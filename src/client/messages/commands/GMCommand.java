...
public class GMCommand {
    ...
    public static class itemEXP extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted){
...
/*    public static class SWORDSPLOSION extends CommandExecute {
    ...
    public static class CancelEvent extends CommandExecute {
    ...
    public static class checkMobID extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
