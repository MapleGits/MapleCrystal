...
/*    public static class LowHP extends CommandExecute {
    ...
    public static class ClearInv extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (splitted[1].equals("all")) {
               ...
               c.getPlayer().dropMessage(6, "Clear inventory syntax: !clearinv <All, Equipped, Equip, Use, Setup, Etc, Cash>");
    ...
    public static class onlineAll extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, "Characters connected: ");
    ...
    public static class CheckPoint extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (chrs == null) {
                ...
                c.getPlayer().dropMessage(6, chrs.getName() + " has " + chrs.getDPoints() + " points.");
            }
            return 1;
        }
    }
    ...
    public static class Npctalk extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
