    ...
    public static class Vac extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted){
            ...
            switch(splitted[1].toLowerCase()){
                case "midteal": c.getPlayer().setChatType(-7); break;
                case "whitebg": c.getPlayer().setChatType(-6); break;
                case "darkpink": c.getPlayer().setChatType(-5); break;
                case "globaldarkpink": c.getPlayer().setChatType(-10); break;
                case "chathide": c.getPlayer().setChatType(-4); break;
                case "chat": c.getPlayer().setChatType(-3); break;
                case "reg": c.getPlayer().setChatType(-3); break;
                case "regular": c.getPlayer().setChatType(-3); break;
                case "topyellow": c.getPlayer().setChatType(-1); break;
                case "notice": c.getPlayer().setChatType(0); break;
                case "popup": c.getPlayer().setChatType(1); break;
                case "lightblue": c.getPlayer().setChatType(2); break;
                case "lightpink": c.getPlayer().setChatType(5); break;
                case "system": c.getPlayer().setChatType(6); break;
                default: c.getPlayer().dropMessage(6, "Syntax: !chatType <midteal, whitebg, globaldarkpink, darkpink, chathide, chat, topyellow, notice, lightblue, lightpink, system>"); break;
            }
            return 1;
        }
    }
