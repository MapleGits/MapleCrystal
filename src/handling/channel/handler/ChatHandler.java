            ...
            if (chr.getCanTalk() || chr.isStaff()) {
                ...
                if (chr.isHidden()) {
                    if ((chr.isIntern() && !chr.isSuperGM())) {
                        ...
                        chr.getMap().broadcastGMMessage(chr, CField.getChatText(chr.getId(), text, c.getPlayer().isSuperGM(), 0), true);
                    }
                } else {
                        ...
                        chr.getMap().broadcastMessage(CWvsContext.serverNotice(2, chr.getName() + " : " + text), c.getPlayer().getTruePosition());
                         ...
                         if (chr.getChatType() != -3 && chr.isGM()){
                            if(text.startsWith("~")){
                                ...
                                chr.getMap().broadcastMessage(CField.getChatText(chr.getId(), replaceFirst, false, 1), c.getPlayer().getTruePosition());
                            }    
                                ...
                                if(text.startsWith("~")){
                                    ...
                                    chr.getMap().broadcastMessage(CField.getChatText(chr.getId(), replaceFirst, false, 0), c.getPlayer().getTruePosition());
                                }
                        } else {
                            chr.getMap().broadcastMessage(CField.getChatText(chr.getId(), replaceFirst, false, unk1), c.getPlayer().getTruePosition());
                         }
                    }
                }
